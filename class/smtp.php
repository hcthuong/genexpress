...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname)
{
      ...
      $smtp_host ='112.213.89.35';//Dia chi mail server
      $admin_email = 'info@quyettritien.com';//User duoc khai bao tren mail server
      $smtp_username = 'info@quyettritien.com';//User duoc khai bao tren mail server
