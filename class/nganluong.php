...
class NL_Checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = '29537';	// Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site 29537

	// Mật khẩu bảo mật
	private $secure_pass= 'phuquockool'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site phuquockool
