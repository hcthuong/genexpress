<?php /* Smarty version 2.6.13, created on 2014-04-11 18:38:15
         compiled from information/in_update.html */ ?>
<!-- Background wrapper -->
<div id="bgwrap">
    <!-- Main Content -->
    <div id="content">
        <div id="main">
            <h1>Cập nhật tin giới thiệu</h1>
            <div class="pad20">
                <!-- Big buttons -->
                <form name="frm_information_upd" method="post" enctype="multipart/form-data" onSubmit="return check_value(frm_information_upd);">
                    <!-- Fieldset -->
                    <fieldset>
...
" <?php if ($this->_tpl_vars['rs'][$this->_sections['rs']['index']]['InCat_ID'] == $this->_tpl_vars['detail']['Information_CatID']): ?>selected="selected"<?php endif; ?> style="background-color:#EEEEEE; font-weight:bold; font-family:Verdana, Arial, Helvetica, sans-serif;"><b><?php echo $this->_tpl_vars['rs'][$this->_sections['rs']['index']]['Name']; ?>
</b></option>
...
" <?php if ($this->_tpl_vars['sub'][$this->_sections['rs']['index']][$this->_sections['sub']['index']]['InCat_ID'] == $this->_tpl_vars['detail']['Information_CatID']): ?>selected="selected"<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&brvbar;--&nbsp;<?php echo $this->_tpl_vars['sub'][$this->_sections['rs']['index']][$this->_sections['sub']['index']]['Name']; ?>
</option>
                                <?php endfor; endif; ?>
                                <?php endfor; endif; ?>
                        ...
                        <p><label for="sf">Tiêu đề: </label>
                            <input type="text" class="mf" name="title" value="<?php echo $this->_tpl_vars['detail']['Title']; ?>
" id="title" maxlength="200"/><font color="#FF0000"><b>*</b></font>
                        </p>
                        <p><label for="sf">Tiêu đề (tiếng Anh): </label>
                            <input type="text" class="mf" name="title_en" value="<?php echo $this->_tpl_vars['detail']['Title_EN']; ?>
" id="title_en" maxlength="200"/><font color="#FF0000"><b>*</b></font>
                        </p>
                        ...
                        <p><label for="sf" style="vertical-align:top" >Mô tả (tiếng Anh): </label>
                            <textarea type="text" name="summary_en" cols="50" rows="5" id="summary_en"/><?php echo $this->_tpl_vars['detail']['Summary_EN']; ?>
</textarea>
                        </p>
                        ...
                        <p><label for="sf" style="vertical-align:top" >Nguồn tin: </label>
                            <input type="text" name="source" class="mf" value="<?php echo $this->_tpl_vars['detail']['Source']; ?>
" id="source" maxlength="100"/>
                        </p>
                        <p>
                            <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['detail']['Information_ID']; ?>
" />
                            <input type="hidden" name="old_img" value="<?php echo $this->_tpl_vars['detail']['Image']; ?>
" />
