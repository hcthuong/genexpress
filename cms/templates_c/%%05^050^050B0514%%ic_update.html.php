<?php /* Smarty version 2.6.13, created on 2014-04-08 09:30:47
         compiled from information/ic_update.html */ ?>
<!-- Background wrapper -->
<div id="bgwrap">
    <!-- Main Content -->
    <div id="content">
        <div id="main">
            <h1>Cập nhật danh mục giới thiệu</h1>
            <div class="pad20">
                <!-- Big buttons -->
                <form name="frm_information_category_add" method="post" onSubmit="return check_value(frm_information_category_add);">
                    ...
                    <fieldset>
                        ...
                        <p><label for="sf">Tên danh mục: </label>
                            <input type="text" class="mf" name="name" value="<?php echo $this->_tpl_vars['detail']['Name']; ?>
" id="name" maxlength="200"/><font color="#FF0000"><b>*</b></font>
                        </p>
                        <p><label for="sf">Tên danh mục (tiếng Anh): </label>
                            <input type="text" class="mf" name="name_en" value="<?php echo $this->_tpl_vars['detail']['Name_EN']; ?>
" id="name_en" maxlength="200"/><font color="#FF0000"><b>*</b></font>
                        </p>
...
" <?php if ($this->_tpl_vars['detail']['Parent_ID'] == $this->_tpl_vars['list_category_parent']['InCat_ID']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['list_category_parent']['Name']; ?>
</option>
                        ...
                        <p>
                            <input type="hidden" name="icid" value="<?php echo $this->_tpl_vars['detail']['InCat_ID']; ?>
" />
